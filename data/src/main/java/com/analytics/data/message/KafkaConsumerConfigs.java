...
public class KafkaConsumerConfigs {
    ...
    public ConsumerFactory<String, CarPostDTO> consumerFactory() {
        ...
        //IMPORTANTE: O groupId faz parte da arquitetura do Kafka onde ele pode balancear caso tenha mais de um microserviço
        //             acessando o mesmo topic e talvez um ficar sem consumir um topic, por isso faz sentindo definir groupId
        //              diferentes quanto se é necessário ter o consumo garantir do kafka
